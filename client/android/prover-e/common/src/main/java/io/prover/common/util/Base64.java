 ...
 * optional padding. Alternative character tables may be supplied to the {@code encodeBase64}
...
public class Base64 {
     ...
     *
     * @param chars Chars to encodeBase64.
     ...
     * Decode base64 chars to bytes.
     *
     * @param base64String string to decode from Base64.
     * @return Decoded bytes.
     */
     ...
     *
     * @param bytes Bytes to encodeBase64.
     * @return Encoded chars.
     */
    public static String encodeBase64(byte[] bytes) {
        return new String(encodeBase64(bytes, encode, pad));
    }
     ...
     * @return Encoded chars.
     */
    public static char[] encodeBase64(byte[] bytes, boolean padded) {
        return encodeBase64(bytes, encode, padded ? pad : 0);
    }
    ...
    /**
     * Encode bytes to base64 chars using the supplied encodeBase64 table and with
     * optional padding.
     *
     * @param src   Bytes to encodeBase64.
     * @param table Encoding table.
     * @param pad   Padding character, or 0 for no padding.
     * @return Encoded chars.
     */
    public static char[] encodeBase64(byte[] src, char[] table, char pad) {
        int len = src.length;
