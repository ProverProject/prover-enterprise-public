...
public class ResolutionSelector {
    ...
    private static final int PREFERED_WIDTH = 1280;
    private static final int PREFERED_HEIGHT = 720;
    ...
    public Size getOptimalVideoSize(Size targetSize, List<Size> availableResolutions, DisplayMetrics displayMetrics) {
        ...
        Size preferedSize = new Size(PREFERED_WIDTH, PREFERED_HEIGHT);

        if (availableResolutions.contains(preferedSize)) {
            return preferedSize;
        }
