...
class VideoQualityViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        currentIndexPath = IndexPath(row: availablePresets.index(of: Settings.currentVideoOutputPreset)!,
                                     section: 0)
...
extension VideoQualityViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath != currentIndexPath {
            ...
            Settings.currentVideoOutputPreset = availablePresets[currentIndexPath.row]
